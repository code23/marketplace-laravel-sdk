...
class BookingReviewService extends Service
{
    ...
    /**
     * Return a list of vendor reviews.
     *
     * By default returns all reviews.
     *
     * @param Int $vendor_id
     ...
     * @return Collection
     */
    public function listVendorReviews(int $vendor_id, $paginate = 0, $page = 1, $with = '', $sort = null)
    {
        // create params & include relationships
        $params = ['with' => $with];
        ...
        // call to api
        $response = $this->http()->get($this->getPath() . '/booking-reviews/vendors/' . $vendor_id, $params);
